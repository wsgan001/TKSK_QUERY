...
//	public int currentVertexID=-1;
	...
	public IndexBuilding(int locid,int K) throws Exception {
...
//		this.POIkwdScores=new HashMap<String, Float>();
		...
		db_GtreeInvertedMap=db.getHashMap("db_GtreeInvertedMap");
...
//				}
	...
	public  void loadPOIToGTree() throws IOException
	{
		...
		while((line=readerPOI.readLine())!=null)
		{
			...
			//get  keywordCount
			HashMap<String, Integer>POIkwdCount=new HashMap<String, Integer>();
			HashMap<String, Float>POIkwdScores=new HashMap<String, Float>();
...
//			{
//				System.out.println(kwd+"===="+POIkwdScores.get(kwd));
//			}
//			if(pid>10)
//			{
//				return;
...
//			System.exit(-1);
	...
	{
		System.out.println("data Saving begin");
//		for(Integer gID:GtreeLeafNodeMap.keySet())
//		{
//			db_GtreeLeafNodeMap.put(gID, GtreeLeafNodeMap.get(gID));
//		}
		...
		db_GtreeInvertedMap.putAll(GtreeInvertedMap);
//		System.out.println(db_GtreeLeafNodeMap.size());
		db_GtreeLeafNodeMap.putAll(GtreeLeafNodeMap);
		
//		int GnodesD=Nodes.get(5050).gtreepath.lastElement();
//		System.out.println("LeafNode of 5050:"+GnodesD);
////		System.out.println("KeySet"+GtreeLeafNodeMap.keySet());
//		if(GtreeLeafNodeMap.containsKey(6200))
//		{
//			HashMap<Integer, Vector<POI_Vertex>> tmp=GtreeLeafNodeMap.get(6200);
//			System.out.println("Tmp:"+tmp.keySet());
//			if(tmp.containsKey(5050))
//			{
//				for(int i=0;i<tmp.get(5050).size();i++)
//				{
//					HashMap<String,Float> kwdm=tmp.get(5050).get(i).kwdScoresMap;
//					System.out.println("I:"+i);
//					for(String kwdN:kwdm.keySet())
//					{
//						System.out.println(kwdN+"==="+kwdm.get(kwdN));
//					}
//				}
//			}else
//			{
...
//		}else
//		{
//			System.out.println("No 6200");
//		}
//		
			
		
		
//		if(GtreeInvertedMap.containsKey(5269))
//		{
//			System.out.println("YEYE");
////			System.out.println(Gtree.get(5269).isleaf);
////			System.out.println(Gtree.get(5269).leafinvlist.toString());
////			System.out.println(Gtree.get(5269).leafnodes.toString());
////			System.out.println(GtreeInvertedMap.get(5269).keySet().toString());
//		}else
//		{
...
//		}
	...
	public static void main(String[] args) throws Exception {
		...
		IndexBuilding test=new IndexBuilding(10, 10);
//		test.TestVertex(12);
